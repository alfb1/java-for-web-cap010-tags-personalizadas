...
public class Lancamento implements Serializable {
	...
	//Ao excluir um usuário as contas são excluidas 
	...
	//Ao excluir uma conta exclui também os lancamentos dessa conta
	@OnDelete( action = OnDeleteAction.CASCADE )
	...
	//ao excluir uma categoria, também se exclui os lancamentos relacionados
	@OnDelete( action = OnDeleteAction.CASCADE )
	...
	//Definindo a precisã do campo para armazenar somente datas, as outras opções são TIME - somente a hora e
	...
	//recomendado pelo hibernate qdo se trata de valores monetários
